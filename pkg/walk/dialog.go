...
func NewDialog(owner Form) (*Dialog, error) {
	return newDialogWithStyle(owner, win.WS_THICKFRAME, 0)
}

func NewDialogWithFixedSize(owner Form) (*Dialog, error) {
	return newDialogWithStyle(owner, 0, 0)
}

func NewDialogWithStyle(owner Form, style uint32, sytle2 uint32) (*Dialog, error) {
	return newDialogWithStyle(owner, style, sytle2)
}
...
func (dlg *Dialog) SetResult(result int) {
	dlg.result = result
}
